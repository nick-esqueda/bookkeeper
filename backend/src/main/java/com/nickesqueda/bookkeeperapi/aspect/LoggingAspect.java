package com.nickesqueda.bookkeeperapi.aspect;
...
public class LoggingAspect {
  @Pointcut(
      "execution(* com.nickesqueda.bookkeeperapi..*(..))")
  public void allPackagesAllMethods() {}

  @Pointcut("execution(* com.nickesqueda.bookkeeperapi.controller.*.*(..))")
  public void allControllerMethods() {}

  @Pointcut("execution(* com.nickesqueda.bookkeeperapi.service.*.*(..))")
